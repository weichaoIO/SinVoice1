...
public class SinGenerator {
    ...
    public static final int BITS_16 = 32768;//2的15次幂
    ...
    public static final int SAMPLE_RATE_441 = 44100;//常用采样率
    ...
    private static final int DEFAULT_BITS = BITS_16;
    private static final int DEFAULT_SAMPLE_RATE = SAMPLE_RATE_441;
